...
\begin{itemize}
	\item Ogni segmento possiede un campo che indica il numero di sequenza, ossia il numero del 
		primo byte in tale segmento.
	\item Il numero di riscontro è il numero dell'ultimo byte correttamente ricevuto +1.
\end{itemize}
