...
Gli indirizzi IP sono gestiti dall'ICANN che a sua volta assegna dei blocchi di indirizzi ai vari
...
Questo metodo è nato per evitare che indirizzi IP appartenenti a dispostivi non connessi alla rete
