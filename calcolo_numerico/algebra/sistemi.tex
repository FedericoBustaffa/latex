...
Per riuscire a calcolare tale fattorizzazione abbiamo bisogno di una \textbf{matrice elementare di Gauss}. Una
matrice $A$ è elementare se è possibile esprimerla in questo modo
\[ A = I + u \cdot v^T \]
...
\[
	...
	\end{pmatrix}
\]
L'inversa di una matrice elementare di Gauss è equivalente alla stessa matrice dove si cambia segno agli elementi
del vettore $u$.
\[ A^{-1} = I - u \cdot e_j^T \]
