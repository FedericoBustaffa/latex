...
\begin{observation}
	...
	Imponendo $R x = y$ possiamo scrivere
	\[
		\begin{cases}
			L y = b \\
			R x = y
...
\begin{theorem}
	...
	\begin{proof}
		...
		\[ x^T = w^T \cdot R_{n-1} \]
		Una volta ricavati $x^T$ e $y$ troviamo $r_{n,n}$ in modo univoco calcolando
		\[ r_{n,n} = a_{n,n} - x^T \cdot y \]
