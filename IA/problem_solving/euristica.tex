...
\[ f(n) = g(n) + h(n) \]
dove $g(n)$ \`e il costo del cammino per arrivare al nodo $n$ dal nodo di partenza e $h(n)$
\`e una stima del costo del cammino per raggiungere il nodo \emph{goal} dal nodo $n$
secondo l'euristica scelta.
