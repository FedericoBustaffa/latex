...
numero \`e fortemente influenzata dalla generazione del precendente.
...
Anche per questo generatore dobbiamo scegliere bene i parametri per rendere il periodo pi\`u lungo possibile (sempre
uguale a $m$). Una scelta di parametri molto comune \`e questa:
\[
	\begin{matrix}
		a & = & \pi    \\
		b & = & e      \\
