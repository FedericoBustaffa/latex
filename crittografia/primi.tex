...
Come abbiamo detto per\`o, $n$ necessita di $\Theta(\log_2 n)$ bit per essere rappresentato, dunque $n$
si pu\`o scrivere come $2^{\log_2 n}$ e questo fa diventare la complessit\`a
\[ O(2^\frac{\log_2 n}{2} \cdot \log^2_2 n) \]
