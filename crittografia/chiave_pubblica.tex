...
Il \textbf{protocollo DH}, dai due crittografi che lo hanno implementato (Diffie ed Hellman), risolve il problema
degli attacchi \emph{man in the middle} ai quali l'RSA \`e vulnerabile, basato sul problema del calcolo del
logaritmo discreto.
...
Affinch\'e il procedimento funzioni i due utenti che intendono comunicare devono scegliere
\begin{itemize}
