...
\include{1-binaria_booleana/1.1-aritmetica_binaria}
\include{1-binaria_booleana/1.2-reti_combinatorie}
\include{1-binaria_booleana/1.3-verilog}
\include{1-binaria_booleana/1.4-reti_sequenziali}
\include{1-binaria_booleana/1.5-componenti_std}
\include{1-binaria_booleana/1.6-parallelismo}
