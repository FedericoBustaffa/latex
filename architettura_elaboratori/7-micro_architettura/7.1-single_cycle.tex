...
Siamo quindi in grado di eseguire un'istruzione ma non di eseguire tante in sequenza. Dobbiamo
infatti riuscire ad implementare un ciclo infinito dentro il quale effettuiamo le operazioni di
fetch-decode-execute. Per farlo dobbiamo sostanzialmente riuscire ad incrementare il \verb|PC|.
