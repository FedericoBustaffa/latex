...
\begin{center}
	\includesvg[inkscapelatex=false, scale=0.7] {circuiti/stallo.svg}
\end{center}
In questo caso l'operazione \verb|beq| è subito dopo \verb|cmp| ma, in generale potrebbe essere
eseguita più avanti. A seconda dei casi potremmo aver bisogno di provocare uno stallo o meno.
