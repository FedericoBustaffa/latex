...
\subsubsection{ROM}
Le \textbf{ROM} (Read Only Memory) sono molto simili, come struttura, alle memorie dinamiche.

Per quanto riguarda una comparazione tra i tre tipi di memoria che abbiamo visto fino ad ora
possiamo dire che i registri sono i più veloci per quanto riguarda lettura e scrittura ma sono
quelli occupano più spazio sul silicio a parità di capienza. Le memorie dinamiche sono quelle più
lente ma che occupano meno spazio sul silicio e le memorie statiche si collocano nel mezzo per
